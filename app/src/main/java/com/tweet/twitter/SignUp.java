...
import com.tweet.twitter.api.Reftofit;
...
//        }
    ...
    void Checkuser(User us) {
        ...
        retrofit2.Call<Check> checkCall = apiClass.calls().check(us);

        checkCall.enqueue(new Callback<Check>() {
            @Override
            public void onResponse(retrofit2.Call<Check> call, Response<Check> response) {
            ...
            @Override
            public void onFailure(retrofit2.Call<Check> call, Throwable t) {
